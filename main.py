...
def parse_args():
    ...
    parser.add_argument('--corpus_name', type=str, 
                        choices=['BBC_News', 'Tweet', 'Bank77', 'Reddit', 'CLINC', 'FewEvent'],
                        default='BBC_News')
    parser.add_argument('--selection', type=str, choices=['edge', 'triangle'], default='triangle')

    parser.add_argument('--encoder_name', type=str, choices=['instructor'], default='instructor')
...
datasets = [
    ...
    {"Corpus": "FewEvent", "Texts": 4742, "Clusters": 34, "Task": "Event"},
]
...
from few_shot_clustering.dataloaders import load_corpus
...
if encoder_name == "instructor":
    ...
    elif corpus_name == "FewEvent":
        cache_path = f"embeddings/few_event_instructor-large.pt"
        file_path = f"data/few_event.jsonl"
